	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "branded items. As a Welcome gift for our New Customers we are providing additional 10% OFF Upto 500 BDT for the first product purchase. To avail this offer you only have "
